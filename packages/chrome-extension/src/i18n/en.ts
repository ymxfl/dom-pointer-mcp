...
const en: Record<MessageKey, string> = {
  ...
  'popup.updateChannelAuto': 'Auto',
  'popup.updateChannelStore': 'Chrome Web Store',
  ...
  'history.copy': 'Copy',
  'history.copySuccess': 'Note copied',
  'history.copyFailed': 'Copy failed: {error}',
  'history.copyEmpty': 'Note is empty, nothing to copy',
