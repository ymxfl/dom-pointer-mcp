...
- cbb08b4: 历史看板每条记录新增"复制"按钮，可复制完整 userNote；复制、回显、删除三个操作按钮改为横排显示在记录信息下方（顺序：复制、回显、删除）。

## 1.7.5

### Patch Changes

- e46182c: 检查更新按钮支持渠道选择：点击更新图标弹出菜单，可选自动检测、Chrome 应用商店或 GitHub 三种渠道后再发起检查，便于在某一渠道被限流时切换到另一渠道。
